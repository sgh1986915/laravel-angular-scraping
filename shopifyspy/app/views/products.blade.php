			...
			<div class="panel-body">
				<div role="tabpanel">
					...
					<ul class="nav nav-tabs piluku-tabs" role="tablist">
						<li role="presentation" class="active"><a href="#amazonProducts" aria-controls="amazonProducts" role="tab" data-toggle="tab">Amazon</a></li>
						<li role="presentation"><a href="#ebayProducts" aria-controls="ebayProducts" role="tab" data-toggle="tab">Ebay</a></li>
						<li role="presentation"><a href="#aliexpressProducts" aria-controls="aliexpressProducts" role="tab" data-toggle="tab">AliExpress</a></li>
					</ul>

					<div class="tab-content piluku-tab-content">
						<!-- AMAZON TAB -->
						<div role="tabpanel" class="tab-pane active" id="amazonProducts">
						...
						<!-- EBAY TAB -->
						<div role="tabpanel" class="tab-pane" id="ebayProducts">
							<ul class="col-xs-12 list-group">
						...
						<!-- ALIEXPRESS TAB -->
						<div role="tabpanel" class="tab-pane" id="aliexpressProducts">
							<ul class="col-xs-12 list-group">
